    ...
    <Modal show={show} onHide={handleClose}>
      <div className='modal'>
        <div className='modal-header'>
          ...
          <button className='modal-header__close-button' onClick={handleClose}><i className="modal-header__close-icon bi bi-x-circle"></i></button>
        </div>
        <div className='modal-content'>
          ...
          <div className='modal-action'>
            <button className='modal-action__button' onClick={handleClose}>Cancel</button>
            <button className='modal-action__button' onClick={() => handleSend(foodItem)}>Add to Cart</button>
          </div>
        </div>
      </div>
    </Modal>
